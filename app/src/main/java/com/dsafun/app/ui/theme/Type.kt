...
// Fira Code Font Family for Code Editor
val firaCodeFontName = GoogleFont("Fira Code")
val firaCodeFontFamily = FontFamily(
    Font(googleFont = firaCodeFontName, fontProvider = provider, weight = FontWeight.Normal),
    Font(googleFont = firaCodeFontName, fontProvider = provider, weight = FontWeight.Medium),
    Font(googleFont = firaCodeFontName, fontProvider = provider, weight = FontWeight.SemiBold)
)
